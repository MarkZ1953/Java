 ...
 * @author castr
 */
public class CalculoAreas1 extends javax.swing.JFrame {
    
    /**
     * Creates new form CalculoAreas
     */
    public CalculoAreas1() {
        initComponents();
    }
...
//                JOptionPane.showMessageDialog(rootPane, "Resultado : " + df.format(Math.PI*Math.pow(Double.parseDouble(txt2.getText()), 2)));    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculoAreas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculoAreas1().setVisible(true);
            }
        });
    }
