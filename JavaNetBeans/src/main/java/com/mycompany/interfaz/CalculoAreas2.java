 ...
 * @author castr
 */
public class CalculoAreas2 extends javax.swing.JFrame {
    
    /**
     * Creates new form CalculoAreas
     */
    public CalculoAreas2() {
        initComponents();
    }
...
//                JOptionPane.showMessageDialog(rootPane, "Resultado : " + df.format(Math.PI*Math.pow(Double.parseDouble(txt2.getText()), 2)));    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculoAreas2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculoAreas2().setVisible(true);
            }
        });
    }
